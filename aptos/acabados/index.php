...
{
 $sql_query="DELETE FROM Acabados WHERE id=".$_GET['delete_id'];
 mysqli_query($con,$sql_query);
 header("Location: $_SERVER[PHP_SELF]");
}
if(isset($_GET['changestatus_id']))
{
 $sql_query="UPDATE Acabados SET `status`='".$_GET['status']."' WHERE id=".$_GET['changestatus_id'];
 mysqli_query($con,$sql_query);
 header("Location: $_SERVER[PHP_SELF]");
}
?>
...
<head>
    ...
    function edt_id(id) {
        window.location.href = 'edit_Acabados.php?edit_id=' + id;
    }

    function view_id(id) {
        window.location.href = 'view_Acabados.php?view_id=' + id;
    }
        ...
        <div id="body">
            <div id="content">
                <table align="center" class="table table-striped">
                    <tr>
                        <th colspan="5"><a href="add_Acabados.php">add Acabados.</a></th>
                    </tr>
                    <th>SL NO</th>
                    <th>numApto</th>
                    ...
                    <?php
                        $sql_query="SELECT * FROM Acabados";
